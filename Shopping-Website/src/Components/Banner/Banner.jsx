        ...
        <div className='container '>
           <div className='grid grid-cols-1 sm:grid-cols-2 gap-6 items-center'>
             ...
             <p className='text-sm text-gray-500 tracking-wide leading-5'>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga in tempore fugiat, nemo autem non doloremque sunt. Fuga nam repudiandae distinctio laudantium praesentium inventore placeat earum consequuntur nulla. Rerum, sit!
             </p>
             ...
             <div className='flex flex-col gap-4'>
              ...
              <div className='flex items-center gap-4'>
              <GiFoodTruck  className='text-4xl h-12 w-12 shadow-sm p-4 rounded-full bg-gray-100
              dark:bg-green-400'/>
